// Import de ce dont on a besoin pour construire le composantAdd commentMore actions
...
export class PokemonListComponent {
  ...
  // computed() crée une valeur dérivée automatiquement à jourAdd commentMore actions
